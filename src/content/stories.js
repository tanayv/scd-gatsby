...
const storySnapshotData = [
  ...
  },
  {
    ...
    body: <>
            ...
            <p className="serif">
            We partnered with professors and students all across the university that told stories about how their fields relate to love and friendship, and we also worked with the CU Community Fab Lab, Illinois MakerLab, McKinley Stress Management Peers, McKinley Sexual Health Peers, Flor Poetry, Illini Swing Society, and the Creative Writing Club.  
            </p>
            <p className="serif">
